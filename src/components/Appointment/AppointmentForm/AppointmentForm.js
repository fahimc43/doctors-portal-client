...
const AppointmentForm = ({ modalIsOpen, closeModal, appointmentOn, date }) => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://agile-temple-59192.herokuapp.com/addAppointment', {
            method: 'POST',
            ...
            >
                ...
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group row mb-3">
                        ...
                        <div className="col-4">
                            <input {...register("age", { required: true })} className="form-control" name="age" placeholder="Your Age" type="number" min="0" />
                            {errors.age && <span className="text-danger">This field is required</span>}
                        </div>
                        <div className="col-4">
                            <input {...register("weight", { required: true })} className="form-control" name="weight" placeholder="Weight" type="number" min="0" />
